...
#creating new versus load game:
    ...
    # 8. MOON GAMEPLAY
        ...
        # Draw Moon rocks and find the closest rock the player can lift.
        active_rock_index = None
        ...
        for i, position in enumerate(rock_positions):
            ...
            if player_rect.colliderect(interaction_rect):
                ...
                distance = ((player_center[0] - rock_center[0]) ** 2 +
                            (player_center[1] - rock_center[1]) ** 2) ** 0.5

                if distance < closest_distance:
                    closest_distance = distance
                    active_rock_index = i

        # Hold E to lift the nearby rock.
        if active_rock_index is not None:
            ...
            if keys[pygame.K_e]:
                ...
                if rock_hold_time >= required_hold_time:
                    ...
                    # Only the randomly selected rock contains the one crystal.
                    if lifted_rock == crystal_rock_index and not crystal_found:
                        crystal_found = True
                        crystals_collected = 1

                        # Reveal the crystal where the rock was lifted.
                        ...
                        # Stop the Moon countdown immediately.
                        elapsed_when_found = (
        ...
        # Show the revealed crystal for 5 seconds.
        if (
            crystal_found
        ...
        # Timer stops as soon as the crystal is found.
        if timer_stopped:
