...
while running:
    ...
    # 8. MOON GAMEPLAY
        ...
        # After the Moon crystal has been shown for 5 seconds,
    ...
    # 13. MARS GAMEPLAY
        ...
        # After the Mars crystal has been shown for 5 seconds,
    ...
    # 17. SATURN GAMEPLAY
        ...
        # Hold E to lift mechanics
        if active_rock_index is not None and not is_stunned:
            prompt = task_font.render(
                "Hold E for 2 seconds to lift the rock",
                True,
                WHITE,
        ...
        for m in meteors:
            ...
            meteor_rect = pygame.Rect(m["x"], m["y"], m["size"], m["size"])
            if not is_stunned and meteor_rect.colliderect(player_rect):
                current_time = pygame.time.get_ticks()
            ...
            elif not is_stunned and m["y"] > HEIGHT:
                m.update(create_meteor(current_level))
