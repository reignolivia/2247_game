...
space_alien_bg = pygame.transform.scale(
    pygame.image.load("spacealienbg.png"), (WIDTH, HEIGHT)
)
...
while running:
    ...
    # 19. SPACE ALIEN SCENE
    elif game_state == "space_alien_scene":
        screen.blit(space_alien_bg, (0, 0))

        # Keep the astronaut at the exact position where E was pressed.
        # No movement code runs in this state.
        screen.blit(current_image, (player_x, player_y))
        if pygame.time.get_ticks() - cutscene_timer >= 2000:
            cutscene_timer = pygame.time.get_ticks()
