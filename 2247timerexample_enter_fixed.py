...
def restart_moon_level():
    global player_x
    global player_y
    global moon_start_time
    global transition_alpha
    global crystals_collected
    global lives
    ...
    # Show the Moon background immediately
    transition_alpha = 255

    # Keep the collision rectangle synchronized with the player
    player_rect.topleft = (player_x, player_y)

    # Restart the timer
    moon_start_time = pygame.time.get_ticks()

    # Return to Moon gameplay
    ...
    for event in pygame.event.get(): #checking for events (actions)
        ...
        if event.type == pygame.KEYDOWN:
            ...
            # Ran-out-of-time screen
                ...
                # Accept the main Enter key and the keypad Enter key
